![nginx 1.9.14](https://img.shields.io/badge/nginx-1.9.14-brightgreen.svg?style=flat-square)
[![Docker Stars](https://img.shields.io/docker/stars/rnbwd/nginx.svg?style=flat-square)](https://hub.docker.com/r/rnbwd/nginx/)
[![Docker Pulls](https://img.shields.io/docker/pulls/rnbwd/nginx.svg?style=flat-square)](https://hub.docker.com/r/rnbwd/nginx/)
[![Docker Size](https://img.shields.io/imagelayers/image-size/rnbwd/nginx/latest.svg?style=flat-square)](https://hub.docker.com/r/rnbwd/nginx/)
[![Docker Size](https://img.shields.io/imagelayers/layers/rnbwd/nginx/latest.svg?style=flat-square)](https://hub.docker.com/r/rnbwd/nginx/)
...
To run it:
    ...
    $ docker run -d -p 80:80 -v /var/run/docker.sock:/tmp/docker.sock:ro rnbwd/nginx
...
Currently this does not work with the new v2 syntax of docker-compose (due to not being compatible with the new network overlay see [#304](https://github.com/rnbwd/nginx/issues/304)). It does work when using the old docker-composer syntax.
...
To set the default host for nginx use the env var `DEFAULT_HOST=foo.bar.com` for example
    ...
    $ docker run -d -p 80:80 -e DEFAULT_HOST=foo.bar.com -v /var/run/docker.sock:/tmp/docker.sock:ro rnbwd/nginx
...
To run nginx proxy as a separate container you'll need to have [nginx.tmpl](https://github.com/rnbwd/nginx/blob/master/nginx.tmpl) on your host system.
...
Or it can be done by mounting in your custom configuration in your `docker run` command:
    ...
    $ docker run -d -p 80:80 -p 443:443 -v /path/to/my_proxy.conf:/etc/nginx/conf.d/my_proxy.conf:ro -v /var/run/docker.sock:/tmp/docker.sock:ro rnbwd/nginx
...
For example, if you have a virtual host named `app.example.com`, you could provide a custom configuration for that host as follows:
    ...
    $ docker run -d -p 80:80 -p 443:443 -v /path/to/vhost.d:/etc/nginx/vhost.d:ro -v /var/run/docker.sock:/tmp/docker.sock:ro rnbwd/nginx
